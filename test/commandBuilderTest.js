...
describe('commandBuilder', () => {
  describe('constructAcknowledgeCommand', () => {
    it('should send request to the correct endpoint', () => {
      ...
      const sendAcknowledgementCommand = constructAcknowledgeCommand(
        stubSendPost
      );
  ...
  describe('constructServiceDowntimeCommand', () => {
    it('should send request to the correct endpoint', () => {
      ...
      const sendScheduleDowntimeCommand = constructServiceDowntimeCommand(
        stubSendPost
      );

      sendScheduleDowntimeCommand(
        validInput.host,
        validInput.service,
        validInput.duration,
        () => {}
    ...
    it('should send the correct data blob for adding downtime to a host', () => {
      ...
      const sendScheduleDowntimeCommand = constructHostDowntimeCommand(
        stubSendPost
      );
